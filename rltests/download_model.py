...
parser.add_argument(
    "-m", "--method", default='hf', help="hf,ms,autodl"
)
parser.add_argument(
    "-r","--repo_id",required=True, help="repo id"
)
parser.add_argument(
    "-x","--XDG_CACHE_HOME", default='', help="XDG_CACHE_HOME"
)
parser.add_argument(
    "-c","--cache_dir", default='', help="cache dir"
)
parser.add_argument(
    "-l","--is_login", default=False, help="is login hf"
)
parser.add_argument(
    "-t","--hf_token", default='', help="hf token"
)
...
def main():
    ...
    if args.method == 'hf':
        dl=HfDownload(args.repo_id,args.cache_dir,hf_token=args.hf_token,is_login=args.is_login)
    elif args.method == 'ms':
        dl=MsDownload(args.repo_id)
    else:
